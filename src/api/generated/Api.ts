...
export interface ScoringModelsListParams {
  /** Фильтр по названию */
  title?: string;
...
export interface ScoringModelByIdParams {
  /** ID услуги */
  id: number;
}

export interface AddScoringModelToApplicationParams {
  /** ID услуги (credit) */
  id: number;
}

export interface ScoringApplicationsListParams {
  /** Фильтр по статусу */
  status?: string;
...
export interface ScoringApplicationByIdParams {
  /** ID заявки */
  id: number;
}

export interface ScoringApplicationsUpdateParams {
  /** ID заявки */
  id: number;
}

export interface ScoringApplicationsDeleteParams {
  /** ID заявки */
  id: number;
}

export interface ScoringApplicationsFormParams {
  /** ID заявки */
  id: number;
}

export interface ScoringApplicationServiceParamsUpdateParams {
  /** ID заявки */
  appId: number;
  /** ID услуги (credit) */
  creditId: number;
...
export interface ScoringApplicationServiceDeleteParams {
  /** ID заявки */
  appId: number;
  /** ID услуги (credit) */
  creditId: number;
...
export namespace ScoringModels {
   ...
   * @response `500` `DsErrorResponse` Внутренняя ошибка сервера
   */
  export namespace ScoringModelById {
    export type RequestParams = {
      /** ID услуги */
      id: number;
    };
   ...
   * @tags scoring-models
   * @name AddScoringModelToApplication
   ...
   * @response `500` `DsErrorResponse` Внутренняя ошибка сервера
   */
  export namespace AddScoringModelToApplication {
    export type RequestParams = {
      /** ID услуги (credit) */
      id: number;
    };
...
export namespace ScoringApplications {
  /**
   * @description Возвращает информацию о корзине (ID черновика и количество услуг)
   * @tags scoring-applications
   * @name ScoringApplicationsBasket
   ...
   * @response `401` `DsErrorResponse` Требуется авторизация
   */
  export namespace ScoringApplicationsBasket {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
   ...
   * @response `500` `DsErrorResponse` Внутренняя ошибка сервера
   */
  export namespace ScoringApplicationsList {
    export type RequestParams = {};
    export type RequestQuery = {
      /** Фильтр по статусу */
      status?: string;
   ...
   */
  export namespace ScoringApplicationById {
    export type RequestParams = {
      /** ID заявки */
      id: number;
    };
   ...
   * @tags scoring-applications
   * @name ScoringApplicationsUpdate
   ...
   * @response `404` `DsErrorResponse` Заявка не найдена
   */
  export namespace ScoringApplicationsUpdate {
    export type RequestParams = {
      /** ID заявки */
      id: number;
    };
   ...
   * @tags scoring-applications
   * @name ScoringApplicationsDelete
   ...
   * @response `404` `DsErrorResponse` Заявка не найдена
   */
  export namespace ScoringApplicationsDelete {
    export type RequestParams = {
      /** ID заявки */
      id: number;
    };
   ...
   * @response `404` `DsErrorResponse` Заявка не найдена
   */
  export namespace ScoringApplicationsForm {
    export type RequestParams = {
      /** ID заявки */
      id: number;
    };
...
export namespace ScoringApplicationServices {
  /**
   * @description Обновляет М-М связь (параметры услуги в заявке)
   * @tags scoring-application-services
   * @name ScoringApplicationServiceParamsUpdate
   ...
   */
  export namespace ScoringApplicationServiceParamsUpdate {
    export type RequestParams = {
      /** ID заявки */
      appId: number;
      /** ID услуги (credit) */
   ...
   * @tags scoring-application-services
   * @name ScoringApplicationServiceDelete
   ...
   * @response `404` `DsErrorResponse` Не найдено
   */
  export namespace ScoringApplicationServiceDelete {
    export type RequestParams = {
      /** ID заявки */
      appId: number;
      /** ID услуги (credit) */
 ...
 */
  ...
  scoringModels = {
     ...
     */
    scoringModelById: (
      { id, ...query }: ScoringModelByIdParams,
      params: RequestParams = {},
    ) =>
     ...
     * @response `500` `DsErrorResponse` Внутренняя ошибка сервера
     */
    addScoringModelToApplication: (
      { id, ...query }: AddScoringModelToApplicationParams,
      params: RequestParams = {},
    ) =>
      this.http.request<DsSuccessResponse, DsErrorResponse>({
  ...
  scoringApplications = {
     ...
     * @response `401` `DsErrorResponse` Требуется авторизация
     */
    scoringApplicationsBasket: (params: RequestParams = {}) =>
     ...
     * @response `500` `DsErrorResponse` Внутренняя ошибка сервера
     */
    scoringApplicationsList: (
      query: ScoringApplicationsListParams,
      params: RequestParams = {},
    ) =>
     ...
     * @response `404` `DsErrorResponse` Заявка не найдена
     */
    scoringApplicationById: (
      { id, ...query }: ScoringApplicationByIdParams,
      params: RequestParams = {},
    ) =>
     ...
     * @response `404` `DsErrorResponse` Заявка не найдена
     */
    scoringApplicationsUpdate: (
      { id, ...query }: ScoringApplicationsUpdateParams,
     ...
     * @response `404` `DsErrorResponse` Заявка не найдена
     */
    scoringApplicationsDelete: (
      { id, ...query }: ScoringApplicationsDeleteParams,
      params: RequestParams = {},
    ) =>
      this.http.request<DsSuccessResponse, DsErrorResponse>({
        path: `/applications/${id}`,
     ...
     * @response `404` `DsErrorResponse` Заявка не найдена
     */
    scoringApplicationsForm: (
      { id, ...query }: ScoringApplicationsFormParams,
      params: RequestParams = {},
    ) =>
      this.http.request<DsSuccessResponse, DsErrorResponse>({
  ...
  scoringApplicationServices = {
     ...
     * @response `404` `DsErrorResponse` Не найдено
     */
    scoringApplicationServiceParamsUpdate: (
      {
        appId,
        creditId,
        ...query
      }: ScoringApplicationServiceParamsUpdateParams,
     ...
     * @response `404` `DsErrorResponse` Не найдено
     */
    scoringApplicationServiceDelete: (
      { appId, creditId, ...query }: ScoringApplicationServiceDeleteParams,
      params: RequestParams = {},
    ) =>
      this.http.request<DsSuccessResponse, DsErrorResponse>({
        path: `/application-products/${appId}/${creditId}`,
